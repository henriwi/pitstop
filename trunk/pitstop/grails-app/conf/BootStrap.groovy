...
class BootStrap {
     ...
     def init = { servletContext ->
			new Tire(id: 1, partNr: "abc123", brand: "Pirelli", tireName: "T-Zero", width: 100, profile: 20, construction: "R", diameter: 10,
					loadIndex: 40, speedIndex: "L", pattern: "Speed beast", tireType: "Sommer").save()
			new Tire(id: 2, partNr: "cdf456", brand: "Pirelli", tireName: "T-Zero", width: 100, profile: 20, construction: "R", diameter: 10,
