	                	...
	                	<td>
	                    	<g:form controller="customerOrder" method="post">
	                      		...
	                      		<g:hiddenField name="requestFromShowCustomerView" value="true" />
	                       		...
	                       		<g:actionSubmit class="deleteTableItem" title="${message(code: 'customerOrder.list.delete.tooltip.label')}" action="delete" value="${message(code: 'list.button.delete.label')}" onclick="return confirm('${message(code: 'customerOrder.button.order.delete.confirm.message')}');" />
	                        </g:form>
	                   </td>
	               </g:ifAllGranted>
				</tr>
