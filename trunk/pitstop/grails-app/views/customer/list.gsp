                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><a class="notSortableColoumn">${message(code: 'customer.postalCode.table.label')}</a></th>
                        
                            <th><a class="notSortableColoumn">${message(code: 'customer.city.table.label')}</a></th>
