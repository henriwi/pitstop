                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'tireHotelOccurrence.id.label', default: 'Id')}" />
                        
                            <g:sortableColumn property="tireLocation" title="${message(code: 'tireHotelOccurrence.tireLocation.label', default: 'Tire Location')}" />
                        
                            <g:sortableColumn property="registrationNumber" title="${message(code: 'tireHotelOccurrence.registrationNumber.label', default: 'Registration Number')}" />
                        
                            <g:sortableColumn property="carType" title="${message(code: 'tireHotelOccurrence.carType.label', default: 'Car Type')}" />
                        
                            <g:sortableColumn property="tireType" title="${message(code: 'tireHotelOccurrence.tireType.label', default: 'Tire Type')}" />
                        
                            <g:sortableColumn property="inDate" title="${message(code: 'tireHotelOccurrence.inDate.label', default: 'In Date')}" />
