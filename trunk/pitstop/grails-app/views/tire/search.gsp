            ...
            <table>
                <tbody>
                      <tr class="prop">
                       ...
                       <tr class="prop">
                       	   <td valign="top" class="name">
                             <g:textField tabindex='3' name="width"/>
                         </td>
                         <td valign="top">
                             <g:textField tabindex='4' name="profile"/>
                         </td>
                         <td valign="top">
                             <g:textField tabindex='5' name="diameter"/>
                         </td>
                       </tr>
 					  <tr class="prop">
                         <td valign="top" class="name">
                             <label for="speedIndex">Hastighetsindex:</label>
                         </td>
                         <td valign="top">
                             <label for="tireType">Sesong:</label>
                         </td>
                         <td valign="top">
                       ...
                       <tr class="prop">
                         ...
                         <td valign="top">
	   						 <g:textField tabindex='8' name="brand"/>
