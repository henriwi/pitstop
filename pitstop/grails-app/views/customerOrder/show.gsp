				...
				<tr>
					...
					<td>
						<g:form controller="customerOrder" action="deliverOrderLine" method="post">
							...
							<g:submitButton class="receiveSupplierOrder" title="${message(code: 'customerOrderLine.recieve.tooltip.label')}" name="deleteFromOrder" value="${message(code: 'list.button.table.label')}" onclick="return confirm('${message(code: 'customerOrder.button.delete.confirm.message')}');" />
						</g:form>
					</td>
				</td>
			</g:each>
