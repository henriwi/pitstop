...
<title>${message(code: 'search.title.label', default: 'S&oslash;k etter dekktype')}</title>
</head>
<body>
	<div class="nav">
	...
	<div class="body">
		...
		<g:form action="fastSearch" method="get">
			<div class="dialog">
				<table>
					<tbody>
						<tr class="prop">
							<td valign="top" class="name"><label for="txtFastSearch"><g:message code="search.fastSearch.label" default="Hurtigs&oslash;k" /></label></td>
		...
		<h1>${message(code: 'search.header.normalSearch.label', default: 'Normals&oslash;k for dekk')}</h1>
		<g:form action="normalSearch" method="get">
			<div class="dialog">
				<table>
					<tbody>
						<tr class="prop">
							<td valign="top" class="name"><label for="width">${message(code: 'tire.width.label', default: 'Bredde:')}</label></td>
							<td valign="top"><label for="profile">${message(code: 'tire.profile.label', default: 'Profile:')}</label></td>
							<td valign="top"><label for="diameter">${message(code: 'tire.diameter.label', default: 'Diameter:')}</label></td>
						</tr>
						<tr class="prop">
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="speedIndex">${message(code: 'tire.speedIndex.label', default: 'Hastighetsindeks:')}</label></td>
						<td valign="top"><label for="tireType">${message(code: 'tire.tireType.label', default: 'Sesong:')}</label></td>
							<td valign="top"><label for="brand">${message(code: 'tire.brand.label', default: 'Merke:')}</label></td>
						</tr>
						<tr class="prop">
							<td valign="top" class="name">
