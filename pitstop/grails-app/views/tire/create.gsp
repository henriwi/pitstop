    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" method="post" >
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="diameter"><g:message code="tire.diameter.label" default="Bredde" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="width"><g:message code="tire.width.label" default="Tommer" /></label>
                                </td>
                           ...
                           <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tireInstance, field: 'speedIndex', 'errors')}">
                                    <g:textField name="speedIndex" value="${tireInstance?.speedIndex}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="tireType"><g:message code="tire.tireType.label" default="Dekk type" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: tireInstance, field: 'tireType', 'errors')}">
                                    <g:textField name="tireType" value="${tireInstance?.tireType}" />
                                </td>
                            </tr>
                ...
                <div class="buttons">
                    <span class="button"><g:submitButton name="Lagre" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" /></span>
                </div>
            </g:form>
        </div>
    </body>
